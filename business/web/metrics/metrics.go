...
// inside of expvar is registered as a singleton. The use of once wil make
...
// Set sets sets the metrics data into the context
func Set(ctx context.Context) context.Context {
	return context.WithValue(ctx, key, m)
}

// AddGroroutines refreshes the goroutine metric every 100 requests
